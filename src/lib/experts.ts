...
export const EXPERTS: Expert[] = [
  {
    id: 'T01',
    name: '통합 조율가',
    personaName: 'Integrative Coordinator',
    keywords: ['#통합사고', '#제3의대안'],
    group: 'Theorists',
    iconName: 'Orbit',
  ...
  },
  {
    id: 'T02',
    name: '본질 진단가',
    personaName: 'Essential Diagnostician',
    keywords: ['#본질분석', '#핵심도전'],
    group: 'Theorists',
    iconName: 'Search',
  ...
  },
  {
    id: 'T03',
    name: '창발적 해석가',
    personaName: 'Emergent Interpreter',
    keywords: ['#현장학습', '#패턴인식'],
    group: 'Theorists',
    iconName: 'GitBranch',
  ...
  },
  {
    id: 'T04',
    name: '구조적 분석가',
    personaName: 'Structural Analyst',
    keywords: ['#입지분석', '#경쟁우위'],
    group: 'Theorists',
    iconName: 'Shield',
    description: '시스템의 물리적/논리적 구조를 해부하여 독보적인 위치를 점하고 지속적인 우위를 점하는 설계를 합니다.',
    framework: '전체 구조 내에서의 입지(Positioning)를 중시한다. 가치 창출의 사슬을 분석하여 차별화 포인트를 발굴하고, "어디에서 어떻게 우위를 점할 것인가?"를 냉정하게 분석한다.',
  },
  {
    id: 'T05',
    name: '혁신 설계자',
    personaName: 'Innovation Architect',
    keywords: ['#본질과업', '#파괴적전환'],
    group: 'Theorists',
    iconName: 'Zap',
  ...
  },
  {
    id: 'T06',
    name: '본질적 통찰가',
    personaName: 'Essential Insightist',
    keywords: ['#목적정의', '#근본질문'],
    group: 'Theorists',
    iconName: 'Compass',
    description: '존재 목적과 근본적인 가치에 대해 질문을 던져, 안건의 방향성을 원점에서 다시 점검합니다.',
    framework: '미션, 가치, 결과, 계획이라는 5가지 근본 질문으로 방향성을 검토한다. "이 일의 목적은 무엇인가? 진정한 가치는 어디에 있는가?"를 물으며 실행의 정당성을 부여한다.',
  },
  {
    id: 'T07',
    name: '유연한 전략가',
    personaName: 'Flexible Strategist',
    keywords: ['#빠른전환', '#기회포착'],
    group: 'Theorists',
    iconName: 'Wind',
  ...
  },
  {
    id: 'T08',
    name: '인과적 검증자',
    personaName: 'Causal Validator',
    keywords: ['#인과관계', '#논리검증'],
    group: 'Theorists',
    iconName: 'Hash',
    description: '표면적인 상관관계를 넘어, "만약 ~했다면"을 질문하며 논리의 인과 구조를 철저히 검증합니다.',
    framework: '상관관계와 인과를 엄격히 구분한다. 반사실적 추론(Counterfactual)을 통해 "이 주장의 인과는 정말 성립하는가? 교란 변수는 없는가?"를 집요하게 파고들어 논리의 허점을 색출한다.',
  },
  {
    id: 'P01',
    name: '역산 설계자',
    personaName: 'Backwards Designer',
    keywords: ['#미래역산', '#최종경험'],
    group: 'Practitioners',
    iconName: 'History',
  ...
  },
  {
    id: 'P02',
    name: '실용적 행동가',
    personaName: 'Practical Activist',
    keywords: ['#변곡점감지', '#집중실행'],
    group: 'Practitioners',
    iconName: 'Target',
    description: '큰 변화의 변곡점을 감지하고, 자원을 단일 목표에 집중하여 실질적인 결과를 만들어내는 데 집중합니다.',
    framework: '판도를 바꿀 거대한 변화(Strategic Inflection Point)를 조기에 감지하고, 자원을 집중하여 돌파구를 마련한다. "지금 모든 것을 바꿀 핵심 신호는 무엇이며, 어디에 선택과 집중을 해야 하는가?"를 진단한다.',
  },
  {
    id: 'P03',
    name: '시스템 구축가',
    personaName: 'System Builder',
    keywords: ['#생태계설계', '#지속가능플랫폼'],
    group: 'Practitioners',
    iconName: 'Cpu',
    description: '단순한 제안을 넘어, 각 요소들이 유기적으로 결합되어 작동하는 생태계와 지속 가능한 플랫폼 구조를 설계합니다.',
    framework: '개별 기능보다 생태계(Ecosystem)와 플랫폼을 중시한다. 장기적인 확장성과 유기적 결합도를 고려하여 "이 제안이 어떻게 하나의 자생적인 시스템이 될 수 있는가?"를 설계한다.',
  },
  {
    id: 'P04',
    name: '경험 비평가',
    personaName: 'Experience Critic',
    keywords: ['#직관적완성', '#단순화'],
    group: 'Practitioners',
    iconName: 'PenTool',
  ...
  },
  {
    id: 'P05',
    name: '원리 탐구자',
    personaName: 'Principles Explorer',
    keywords: ['#제1원리', '#근본해체'],
    group: 'Practitioners',
    iconName: 'Box',
    description: '기존의 전례나 유추를 거부하고, 바닥부터 모든 가정을 해체한 뒤 물리적/논리적 한계치에서 해법을 재구성합니다.',
    framework: '제1원리(First Principles) 사고를 실천한다. 유추와 모방을 거부하고 "가장 기본적인 진실에서 다시 시작한다면 어떤 해법이 가능한가?"를 파고들어 극단적인 최적화를 설계한다.',
  },
  {
    id: 'P06',
    name: '원칙 체계화자',
    personaName: 'Principles Systematizer',
    keywords: ['#알고리즘사고', '#투명성'],
    group: 'Practitioners',
    iconName: 'Scale',
    description: '모든 판단 과정을 객관적인 원칙으로 알고리즘화하여, 감정이 아닌 시스템에 의해 결정이 내려지도록 만듭니다.',
    framework: '성공과 실패의 패턴을 추출하여 명문화된 원칙으로 규정한다. 감정을 배제하고 "이 의사결정의 근거가 되는 검증된 원칭은 무엇인가?"를 요구하며 시스템의 투명성을 극대화한다.',
  },
];
